...
public interface RepaymentHelperService {
	 ...
	 * @param duration
	 *            optional parameter that represent the loan installment duration.
	 * 
	 ...
	 * 
	 * @param loanSpecs
	 *            all the loan specifications
	 * @param remainingAmount
	 *            remaining amount after (n - 1) of installment
	 */
	 ...
	 *            periodic payment on an annuity.
	 * @param principal
	 *            base amount after subtracting interest from annuity.
	 * @param installmentInterest
	 *            amount of interest rate.
	 * @param loanAmount
	 *            initial outstanding principal.
	 * @param remainingAmount
	 *            remaining initial outstanding principal after subtracting annuity
	 *            payment.
	 * 
	...
	/**
	 * Helper Method to convert double value to BigDecimal object with scale 2 and
	 * even rounding mode
	 * 
	 * @param value
	 ...
	 */
	static BigDecimal convertToBigDecimal(double value) {
